...
public class SFTPHelper {
    ...
    public SFTPHelper(string host,string user,string pwd) {
		UnityEngine.Debug.Log("host:"+host+" user:"+user+" pwd:"+pwd);
    ...
    public ArrayList GetFileList(string remotePath,string fileType) {
        try {
            ...
            foreach(Tamir.SharpSsh.jsch.ChannelSftp.LsEntry qqq in vvv) {
                ...
                if(sss.Length > (fileType.Length + 1) && fileType == sss.Substring(sss.Length - fileType.Length)) { objList.Add(sss); } else { continue; }
            }
