...
public class UIPanelInspector : UIRectEditor
{
	...
	protected override bool ShouldDrawProperties ()
	{
		...
		float clippingEffect = EditorGUILayout.Slider("Effect", mPanel.clippingEffect, 0f, 1f);
		...
		if (clippingEffect != mPanel.clippingEffect)
		{
			NGUIEditorTools.RegisterUndo("Panel Effect", mPanel);
			mPanel.clippingEffect = clippingEffect;
		}
