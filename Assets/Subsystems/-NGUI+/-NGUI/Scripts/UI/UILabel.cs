...
public class UILabel : UIWidget
{
    ...
    public bool mEnableSpaceXInEn = false;

    /// <summary>
    /// Font size after modifications got taken into consideration such as shrinking content.
    /// </summary>

    public bool enableSpaceXInEn
    {
        get
        {
            return mEnableSpaceXInEn;
        }
        set
        {
            mEnableSpaceXInEn = value;
        }
    }
	...
	public int spacingX
	{
		...
		{
            /*
            if(GameCore.Config.CurLocal == GameCore.Local.Local_CN || GameCore.Config.CurLocal == GameCore.Local.Local_TW)
            {
                return mSpacingX;
            }
            else 
   ...
   */        
	...
	public float effectiveSpacingX
	{
		get
		{
            if (!enableSpaceXInEn)
            {
                return mUseFloatSpacing ? mFloatSpacingX : spacingX;
            }
            else
            {
