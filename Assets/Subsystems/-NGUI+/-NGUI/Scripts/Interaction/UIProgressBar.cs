...
public class UIProgressBar : UIWidgetContainer
{
	...
	public virtual void ForceUpdate ()
	{
		...
		if (mFG != null)
		{
			...
			if (isHorizontal)
			{
				if (sprite != null && (sprite.type == UIBasicSprite.Type.Filled || sprite.type == UIBasicSprite.Type.SlicedFilled))
				{
			...
			else if (sprite != null && (sprite.type == UIBasicSprite.Type.Filled || sprite.type == UIBasicSprite.Type.SlicedFilled))
			{
				if (sprite.fillDirection == UIBasicSprite.FillDirection.Horizontal ||
					sprite.fillDirection == UIBasicSprite.FillDirection.Vertical)
				{
		...
		if (thumb != null && (mFG != null || mBG != null))
		{
			...
			if ((((mFG != null) ? mFG : mBG) as UIBasicSprite).type == UIBasicSprite.Type.SlicedFilled)
				br = Vector4.zero;
			corners[0].x += br.x;
			corners[1].x += br.x;
			corners[2].x -= br.z;
